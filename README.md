...
- El `user_id` para el log de auditoría se toma en todos los casos del JWT verificado (`TablaService` y `POST /historial/`), nunca de un valor que mande el cliente sin validar.
